...
void dimmerLamp::timer_init(void)
{
	...
	timer = timerBegin(320000); // 80 Mhz / 250 prescaler of original code
	timerAttachInterrupt(timer, &onTimerISR);
        // Original value of 30... 
        // (80 ^ 10^6 / 250) Hz / (100 Hz * 100 steps of array) = 32 timer step
        // So every 30 leave a small delay for the zero crossing
